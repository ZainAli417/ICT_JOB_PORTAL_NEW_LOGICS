...
class _AdminDashboardBodyState extends State<_AdminDashboardBody> {
  ...
  Map<String, dynamic> _normalizeMap(dynamic m) {
    return AdminDashboardProvider.normalizeMapStatic(m);
  }
  ...
  Future<void> _openDetails(BuildContext context, String requestId) async {
    ...
    final prov = Provider.of<AdminDashboardProvider>(context, listen: false);
  ...
  @override
  Widget build(BuildContext context) {
    final prov = Provider.of<AdminDashboardProvider>(context);
  ...
  Widget _buildModernHeader(BuildContext context, AdminDashboardProvider prov) {
    return Container(
  ...
  Widget _buildStatsSection(AdminDashboardProvider prov) {
  ...
  Widget _buildRequestsList(BuildContext context, AdminDashboardProvider prov, bool isWide) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
  ...
  Widget _buildDetailsSection(BuildContext context, AdminDashboardProvider prov) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(20),
  ...
  Widget _buildDetailsPanel(BuildContext context, AdminDashboardProvider prov, Map<String, dynamic> details) {
  ...
  void _showRequestDetailsModal(BuildContext context, AdminDashboardProvider prov, String requestId) async {

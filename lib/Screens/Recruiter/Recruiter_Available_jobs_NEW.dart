          ...
          Expanded(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text('Job Listing', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w800, color: _textPrimary, letterSpacing: -0.8)),
                    ...
                    Container(
                      ...
                      child: Text('Pro', style: GoogleFonts.poppins(fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white)),
                    ),
                  ],
                ),
                const SizedBox(height: 2),
                Text('Discover and manage your perfect candidates', style: GoogleFonts.poppins(fontSize: 13, color: _textSecondary, fontWeight: FontWeight.w400)),
              ],
            ),
          ),
          _buildStatPill('${_filteredJobs.length}', 'Active Jobs', Icons.rocket_launch, _primary),
          const SizedBox(width: 12),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(Icons.apartment_rounded, size: 16, color: _textSecondary),
                                const SizedBox(width: 6),
                                Flexible(
                                  child: Text(
                                    company,
                      ...
                      if (postedAgo.isNotEmpty)
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [_success.withOpacity(0.15), _success.withOpacity(0.08)],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
                            borderRadius: BorderRadius.circular(8),
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Icon(Icons.schedule_rounded, size: 14, color: _success),
                              const SizedBox(width: 6),
                              Text(
                                postedAgo,
                                style: GoogleFonts.poppins(
